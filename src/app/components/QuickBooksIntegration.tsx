    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-semibold flex items-center gap-2">
          <Link2 className="w-6 h-6 text-[#1B4E9B]" />
      ...
      {!isConnected ? (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
                  ...
                  <li>Add your redirect URI: <code className="bg-blue-200 px-2 py-1 rounded text-xs">https://yourapp.com/callback</code></li>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                <Key className="w-4 h-4 text-[#1B4E9B]" />
                Client ID
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                <Settings className="w-4 h-4 text-[#1B4E9B]" />
                Realm ID (Company ID)
              </label>
              <input
                type="text"
        ...
        <div className="space-y-6">
          <div className="p-6 bg-gradient-to-r from-green-50 to-teal-50 border-2 border-green-300 rounded-lg">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-[#1B4E9B] to-[#20B2AA] text-white rounded-lg hover:from-[#153d7a] hover:to-[#1a8f8f] transition-colors font-semibold shadow-lg"
            >
              Sync Now
            </button>
            <button
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-teal-50 border-2 border-[#1B4E9B] rounded-lg">
